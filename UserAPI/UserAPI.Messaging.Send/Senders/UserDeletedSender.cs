...
{
    public class UserDeletedSender : IUserDeletedSender
    {
        ...
        {
            _queueName1 = "Chat" + rabbitMqOptions.Value.QueueName + "UserDeleted";
            _queueName2 = "Post" + rabbitMqOptions.Value.QueueName + "UserDeleted";
            _exchangeName = "userDeleted-exchange";
